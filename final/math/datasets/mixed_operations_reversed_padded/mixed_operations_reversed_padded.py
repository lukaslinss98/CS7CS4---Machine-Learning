from final.math.util.generate_dataset import write_to_file
import numpy as np

from final.math.util.generate_dataset import Operation, generate_dataset
...
write_to_file(
    'training_mixed_double_single_reversed_padded.txt',
    data=[
        *train_add_single,
        *train_add_double,
        *train_sub_single,
...
write_to_file(
    'test_mixed_double_single_reversed_padded.txt',
    data=[
        *test_add_single,
        *test_add_double,
        *test_sub_single,
