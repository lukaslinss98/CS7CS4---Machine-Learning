...
train_depth2, test_depth2 = generate_boolean_expressions(20000, max_depth=2, percentage_unary=0.25, symmetrical=False)
train_depth1, test_depth_1 = generate_boolean_expressions(20000, max_depth=1, percentage_unary=0.25, symmetrical=False)
