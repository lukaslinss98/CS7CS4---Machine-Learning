...
train_depth3, test_depth3 = generate_boolean_expressions(5000, max_depth=3, percentage_unary=0.25, symmetrical=False)

write_to_file('train_mix_depth_all_unsymmetric.txt', [*train_depth1,*train_depth2,*train_depth3])
write_to_file('test_mix_depth_all_unsymmetric.txt',[ *train_depth1, *test_depth2, *test_depth3])
